...
export class SignInComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private apiService: ApiService, private route: Router, private authService: AuthService,
              private activatedRoute: ActivatedRoute, private toaster: ToastrService, private location: Location) { }
  ...
  signUp(): void {
    if (this.signInType === 'cart') {
      ...
      this.route.navigate(['/sign-up'], { queryParams: { origin: 'cartAddress' } });  // navigate to signUp with queryParams 'cartAddress'
    } else {
