...
export class ProductDetailsComponent implements OnInit {
  ...
  dummyImg: string =
    "assets/images/card-images/surfaceAgri_closedCouple/CrossSectionalDrawing.png";
    ...
    if (
      ...
      if (
        ...
        this.thumbnailImages.push(
          {
            imgSrc:
              "assets/images/Multipurpose_GACW/GA BARESHAFT AND CLOSE COUPLED DC 012 022 032.jpg",
            name: "GA DWG",
            alt: "Image Required",
            heading: "General Arrangement Drawing",
          },
          {
            imgSrc:
              "assets/images/Multipurpose_GACW/CS DCAC BARESHAFT 012 022 032.jpg",
            name: "CS DWG",
            alt: "CS DWG",
            heading: "Cross Sectional Drawing",
          }
        ...
        this.thumbnailImages.push(
          {
            imgSrc:
              "assets/images/Multipurpose_GACW/GA BARESHAFT AND CLOSE COUPLED DC 41 51.jpg",
            name: "GA DWG",
            alt: "Image Required",
            heading: "General Arrangement Drawing",
          },
          {
            imgSrc:
              "assets/images/Multipurpose_GACW/CS DCAA BARESHAFT 041 051.jpg",
            name: "CS DWG",
            alt: "CS DWG",
            heading: "Cross Sectional Drawing",
          }
  ...
  getPerformanceCurve(): void {
    if (
      ...
      if (this.productId === "DCAC012" && this.pumpSpeed[0] === "800") {
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC012/DC_012_800RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC012/DC_012_960RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC012/DC_012_1200RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC012/DC_012_1450RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC022/DC_022_800RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC022/DC_022_960RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC022/DC_022_1200RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC022/DC_022_1450RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC032/DC_032_800RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC032/DC_032_960RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC032/DC_032_1200RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC032/DC_032_1450RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC041/DC_041_800RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC041/DC_041_960RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC041/DC_041_1200RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC041/DC_041_1450RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC051/DC_051_800RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC051/DC_051_960RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC051/DC_051_1200RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
        ...
        this.thumbnailImages.push({
          imgSrc:
            "assets/images/Multipurpose_PC_New/MultipuposeBS/DC051/DC_051_1450RPM.jpg",
          name: "PERFORMANCE CURVE",
          alt: "Image Required",
          heading: "Performance Curve",
        });
  ...
  getProductDetails(productId: string, poleType: string): void {
    ...
    this.apiService.productById(productId, poleType).subscribe(
      (res) => {
        if (res[`code`] === 200) {
    ...
    if (this.selectedProduct.spares.length > 0) {
      this.selectedProduct.spares.filter((eachSpare) => {
        if (
          ...
          eachSpare.productPrice !== "NULL" &&
          eachSpare?.productPrice !== 0
        ) {
          let spareDiscountPrice = 0;
          spareDiscountPrice =
            eachSpare?.productPrice - eachSpare?.productPrice * 0.1;
  ...
  addToCart(): void {
    ...
    this.accessories.forEach((ele) => {
      if (ele.accessoryQuantity >= 1) {
        const accessory = new CartDetails(
          ...
          0,
          "accessory",
          this.pumpSpeed.length
            ? this.pumpSpeed[1]
            : this.selectedProduct?.details?.pole,
          ...
          this.pumpSpeed.length
            ...
            : this.selectedProduct?.details?.speed + " RPM",
    ...
    if (sessionStorage.getItem("id")) {
      ...
      if (
        ...
        this.updateCartDetails(
          ...
          sparesToAdd,
          "session"
        ); // calling upDataCart to store in session
      } else {
        const cartArray = [];
        cartArray.push({ ...cart });
  ...
  updateCartDetails(
    ...
    // cartDetails length is greater than 0
      ...
      for (let i = 0; i < cartDetails.length; i++) {
        if (cartDetails[i].type === "product") {
          ...
          cartNotExist = false;
          if (
            cartDetails[i].driveType === cart.driveType &&
          ...
          for (let j = 0; j < accessoriesToAdd.length; j++) {
            if (
              accessoriesToAdd[j].description === cartDetails[i].description &&
              ...
              if (
                !cartDetails.some(
                  (res) =>
                    res.description === accessoriesToAdd[j].description &&
          ...
          for (let j = 0; j < sparesToAdd.length; j++) {
            if (
              sparesToAdd[j].description === cartDetails[i].description &&
    ...
    if (type === "add") {
      ...
      this.apiService.updateCart(updateCart).subscribe(
        (res) => {
          if (res[`code`] === 200) {
